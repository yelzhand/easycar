...
SECRET_KEY = 'django-insecure-%y443&tjrh0e@hw690%!%huohhun46c=mm$e&@9*$m168*aj+j'
...
SIMPLE_JWT = {
    ...
    'REFRESH_TOKEN_LIFETIME': timedelta(days=0),  # Adjust if needed
    'ROTATE_REFRESH_TOKENS': False,
    'BLACKLIST_AFTER_ROTATION': True,

    # Add any other Simple JWT settings here as needed
}
